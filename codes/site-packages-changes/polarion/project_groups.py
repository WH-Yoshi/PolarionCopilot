...
class ProjectGroup(object):
    ...
    def __init__(self, polarion, name):
        ...
        try:
            self._project_group = self._find_group_recursive(default_project_group.uri, name)
    ...
    def get_workitems(self, query, order='Created', field_list=None, limit=-1) -> list:
    ...
    def get_workitem_with_fields(self, query='', order='Created', limit=-1, field_list=None):
        return_list = []
        list_projects = ''
        ...
        workitems = self.get_workitems(query, order, ['id', 'project', 'type'], limit)
